...
1. Przeczytaj wklejony poniżej opis mechaniczny.
2. Zignoruj wartości liczbowe (np. "3k6", "1 min", obrażenia, zasięgi w metrach) oraz terminologię gry (np. "Test Zręczności", "akcja").
3. Skup się wyłącznie na wizualizacji fizycznego efektu działania czaru: jak wygląda magia, co robi z celem i otoczeniem. Przełóż suche fakty na dramatyczną scenę.



STYL GRAFICZNY I FORMAT:
1. Format: Orientacja wertykalna (pionowa), proporcje 2:3 (wysoki obraz).
2. Styl: Surowy, odręczny szkic wykonany węglem, ołówkiem i tuszem na starym, pożółkłym, zniszczonym pergaminie.
3. Technika: Wyraźne kreskowanie (cross-hatching) do cieniowania, szkicowe, dynamiczne linie. Wygląd strony wyrwanej z antycznego bestiariusza lub grimuaru maga. Monochromatyczna paleta barw (sepia, czerń, odcienie szarości i brązu).
4. Obraz ma nie posiadać żadnych napisów.
5. Każdy wklejony opis bedziesz generowal jako obraz
